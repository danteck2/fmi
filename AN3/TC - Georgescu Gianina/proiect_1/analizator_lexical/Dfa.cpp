...
bool is_first_char_for_id(char c) {
    return is_letter(c) || c == '_';
}
bool is_char_for_id(char c) {
    return is_first_char_for_id(c) || is_digit(c);
}
bool is_not_char_for_id(char c) {
...
Dfa::Dfa(const char *file_name) {
	...
	list_initial.push_back(std::make_pair<>(is_star, STAR));
	...
	list_initial.push_back(std::make_pair<>(is_less, LESS_THAN));
	list_initial.push_back(std::make_pair<>(is_greater, GREATER_THAN));
	...
	list_initial.push_back(std::make_pair<>(is_non_token, NON_TOKEN_SEPARATOR));
	list_initial.push_back(std::make_pair<>(is_first_char_for_id, IDENTIFIER));
	...
	list_identifier.push_back(std::make_pair<>(is_char_for_id, IDENTIFIER));
	list_identifier.push_back(std::make_pair<>(is_not_char_for_id, END));
	this->transitions[IDENTIFIER] = list_identifier;

	transitions_list list_plus;
	list_plus.push_back(std::make_pair<>(is_plus, PLUS));
	list_plus.push_back(std::make_pair<>(is_plus, OPERATOR));
	list_plus.push_back(std::make_pair<>(is_equal, PLUS));
	...
	list_minus.push_back(std::make_pair<>(is_minus, MINUS));
	list_minus.push_back(std::make_pair<>(is_minus, OPERATOR));
	list_minus.push_back(std::make_pair<>(is_greater, OPERATOR));
	...
	list_equal.push_back(std::make_pair<>(is_equal, EQUAL));
	...
	list_less_than.push_back(std::make_pair<>(is_less, SHIFT_LEFT));
	...
	list_greater_than.push_back(std::make_pair<>(is_greater, SHIFT_RIGHT));
	...
	list_shift_left.push_back(std::make_pair<>(is_less, SHIFT_LEFT));
	list_shift_left.push_back(std::make_pair<>(is_equal, SHIFT_LEFT));
	...
	list_shift_right.push_back(std::make_pair<>(is_greater, SHIFT_RIGHT));
	list_shift_right.push_back(std::make_pair<>(is_equal, SHIFT_RIGHT));
	...
	list_and.push_back(std::make_pair<>(is_and, AND));
	...
	list_point.push_back(std::make_pair<>(is_char_for_id, END));
	...
	list_non_token_sep.push_back(std::make_pair<>(is_non_token, NON_TOKEN_SEPARATOR));
	...
	list_char_escape_x.push_back(std::make_pair<>(is_hexa, CHAR_ESCAPE_HEX1));
	...
	//list_string.push_back(std::make_pair<>(is_new_line, STRING_ESCAPE));
	...
	list_exponent.push_back(std::make_pair<>(anything, ERROR)); //ERROR daca este exponent
	...
	list_hexa.push_back(std::make_pair<>(is_hexa, HEXA));
