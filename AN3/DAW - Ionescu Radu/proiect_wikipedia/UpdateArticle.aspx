<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateArticle.aspx.cs" Inherits="UpdateArticle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="padding: 10px">
        <asp:Button ID="UpdateButton" runat="server" Text="Save Article" OnClick="SaveButton_Click" />
    </div>
    <div style="padding: 10px">
